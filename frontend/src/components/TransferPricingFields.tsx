...
function TransferPricingFields({ onChange }: TransferPricingFieldsProps) {
  ...
  return (
    <section>
      ...
      <p>
        Paid separately to your local grid company (e.g. Elenia, Caruna) — not your electricity
        retailer.
      </p>
      ...
      {type === 'seasonal' && (
        <>
          <p className="hint">
            Winter: Nov 1 – Mar 31. Winter day: Mon–Sat 07:00–21:00. Winter night: rest of winter.
            Rest of year: Apr 1 – Oct 31, all the time. (Common Finnish DSO definitions, e.g.
            Elenia's Kausisähkö — check your own contract for exact hours.)
          </p>
